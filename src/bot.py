...
def main():
    print(get_display_text("Mini Company Knowledge Bot (Simple)"))
    print(get_display_text("Type your question. Type 'exit' to quit."))
    print("-" * 50)
    ...
    while True:
        ...
        if score < MIN_SCORE_TO_ANSWER or not answer:
            ...
            print(get_display_text("Bot: می‌توانید درباره مرخصی، محصول، پشتیبانی یا قوانین داخلی سوال بپرسید."))
            continue

        print(get_display_text("\nBot: ") + get_display_text(answer))
